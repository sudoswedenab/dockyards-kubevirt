...
require (
	...
	github.com/siderolabs/cluster-api-bootstrap-provider-talos v0.8.2
	github.com/siderolabs/cluster-api-control-plane-provider-talos v0.7.1
...
replace github.com/siderolabs/cluster-api-bootstrap-provider-talos => github.com/sidero-community/cluster-api-bootstrap-provider-talos v0.8.2

replace github.com/siderolabs/cluster-api-control-plane-provider-talos => github.com/sidero-community/cluster-api-control-plane-provider-talos v0.7.1
...
require (
	...
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20250220230227-13450ba9d760 // indirect
